      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <motion.div
            ...
            className="w-16 h-16 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center shadow-xl shadow-purple-200 mb-4"
          >
            <Gift className="w-8 h-8 text-white" />
          </motion.div>
          <h1 className="text-2xl font-bold gradient-text">Добро пожаловать</h1>
